report 50701 "Mcd-Sales Shipment"
{
            ...
            dataitem("Sales Shipment Line"; "Sales Shipment Line")
            {
                ...
                dataitem("Item Ledger Entry"; "Item Ledger Entry")
                {
                    ...
                    begin
                        ...
                        IF i = 1 THEN begin
                            if "Serial No." <> '' then serialtext:='Serial No. : ' + "Serial No."
                            else
                                serialtext:='Lot No. : ' + "Lot No.";
                        end
                        ELSE
                        begin
                            if "Serial No." <> '' then serialtext:="Serial No."
                            else
                                serialtext:="Lot No.";
                        end;
                    ...
                    dataitem(SalesShptLine; Integer)
                    {
                        ...
                        begin
                            ...
                            WITH TempSalesShipmentLine DO BEGIN
                                ...
                                IF DisplayAssemblyInformation THEN IF TempSalesShipmentLineAsm.GET("Document No.", "Line No.")THEN BEGIN
 ...
 CLEAR(CopyTxt)
    ...
    Protected var skipzerolines: boolean;
